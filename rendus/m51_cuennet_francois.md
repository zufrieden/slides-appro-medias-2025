# M51-1/2 CUENNET FRANCOIS - PSYCHOLOGIE EN UX

# ETAT INITIAL ET OBJECTIFS À RENDRE POUR LE 4 MARS 23h59

## Mon sujet d'étude est ...

la psychologie derrière les comportements et interactions avec des interfaces digitales.
...
Actuellement, mon niveau de connaissance s'arrête aux principes de Nielsen (heuristiques d'utilisabilité pour la conception d'interfaces utilisateur) et à certains principes de design élaborés par Don Norman. Je veux ainsi aller plus loin dans certains principes et règles de UX en comprenant les comportements sous-jacent de l'humain. 

## Objectifs

Spécifique -> Je vais lire 2 livres: "Laws of UX" et "100 things every designer needs to know about people"
Mesurable → Je vais lire au moins 8 pages par jour et prendre des notes sur les concepts clés de chaque livre.
Atteignable -> Je peux consacrer mes aller-retours en train jusqu'à la HEIG chaque jour, me permettant d'arriver à mes objectifs journaliers.
Réalistes -> Cet objectif est compatible avec mes études et travail de Bachelor, et m'aidera dans mes futurs travaux de UX.
Temporel → Je terminerai la lecture des deux livres d’ici le 25 mars, soit avant le rendu du 28 mars, en respectant mon rythme de 8 pages par jour.

Je vais évaluer mon niveau de connaissance actuel et le comparer avec mon niveau après la lecture de ces deux livres.
